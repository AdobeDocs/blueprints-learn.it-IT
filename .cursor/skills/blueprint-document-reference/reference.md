...
|------|---------|--------------------|
| **Panoramica / hub** | Introduce un prodotto o un’area; collegamenti alle blueprint dello scenario | e.g. `overview.md`, `journey-optimizer-overview.md` |
...
| **Passaggi per l&#39;implementazione** | Per i blueprint di scenari con un percorso definito | Elenco numerato. Ogni passaggio: azione + collegamento ad Experience League in cui si trova la procedura. Non copiare le procedure complete. |
