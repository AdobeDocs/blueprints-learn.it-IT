...
---
# Modello sezione caso d’uso settore

Ogni caso d’uso all’interno di un file di panoramica del settore segue esattamente questa struttura.
...
### Esempio fondamentale (vendita al dettaglio)
...
### Esempio emergente (assistenza sanitaria)
