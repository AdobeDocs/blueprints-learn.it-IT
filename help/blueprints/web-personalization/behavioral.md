...
<img src="assets/behavioral_personalization.svg" alt="Architettura di riferimento per il blueprint per la personalizzazione web basata sul comportamento" style="width:80%; border:1px solid #4a4a4a" />
