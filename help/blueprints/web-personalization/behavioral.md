...
1. Mediante SDK tradizionali per specifiche applicazioni (ad esempio, AppMeasurement.js). [Consulta il blueprint per l’SDK delle specifiche applicazioni](../data-ingestion/appsdk.md)
