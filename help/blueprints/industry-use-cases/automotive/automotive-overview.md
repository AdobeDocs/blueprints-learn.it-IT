...
- Le regole di idoneità basate su livelli devono essere configurate nelle decisioni di [!DNL Journey Optimizer] per determinare quali proprietari sono idonei per le offerte esclusive, l&#39;accesso anticipato a nuove rivelazioni di veicoli e i rimborsi dei premi dei partner, garantendo che solo i membri idonei ricevano ciascuna categoria di benefit.
- La logica di arbitrato dell&#39;offerta deve valutare le comunicazioni in sospeso da entrambi i canali rivenditore e OEM prima che venga inviato qualsiasi messaggio, eliminando le promozioni a priorità inferiore o in conflitto per impedire allo stesso proprietario di ricevere offerte contraddittorie simultaneamente.
- Il coordinamento tra canali deve coinvolgere i sistemi CRM dei dealer, le proprietà digitali OEM, i canali di notifica delle auto connesse e i punti di contatto del servizio in modo che le interazioni di fidelizzazione siano coerenti indipendentemente da dove si impegna il proprietario.
