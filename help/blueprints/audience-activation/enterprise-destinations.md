...
<img src="assets/enterprise_destination_activation.svg" alt="Architettura di riferimento per lo scenario di attivazione aziendale" style="width:90%; border:1px solid #4a4a4a"  class="modal-image" />
