...
<img src="../assets/gcm.png" alt="Architettura di riferimento per l’attivazione di Google Customer Match" style="width:80%; border:1px solid #4a4a4a" />
