...
* Tieni presente che le destinazioni batch non supportano l’attivazione di eventi di modifica dei soli attributi. È possibile inviare iscrizioni di pubblico complete o incrementali insieme agli attributi selezionati per l’attivazione.

### Attivazione di segmenti batch nelle destinazioni streaming

* È supportata l’attivazione dei segmenti in batch per le destinazioni streaming. Poiché i profili si qualificano per l’appartenenza al pubblico da processi di segmenti batch, tali realizzazioni possono essere attivate tramite l’attivazione in streaming.
