...
<img src="assets/anonymous_activation.svg" alt="Architettura di riferimento per il blueprint Attivazione del pubblico con dati anonimi" style="width:90%; border:1px solid #4a4a4a"  class="modal-image" />
...
* [Blueprint per l’attivazione di clienti noti](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/audience-activation/known-customer-audience-activation/known.html?lang=it)
