...
description: Scopri come creare la shell di una campagna orchestrata e rivederne le opzioni di pianificazione predefinite.
doc-type: article
...
![Seleziona Adobe Journey Optimizer dal cassetto delle app](assets/create-an-orchestrated-campaign-select-ajo-app.png)
...
![Opzioni modulo di pianificazione per la frequenza con cui il flusso di lavoro della campagna esegue &quot;Opzioni modulo di pianificazione&quot;](assets/create-an-orchestrated-campaign-scheduler-options.png "Opzioni modulo di pianificazione")
