...
description: Scopri come creare un brand in Adobe Journey Optimizer caricando una linea guida per il brand PDF, perfezionando i dettagli estratti e pubblicandola per l’utilizzo in tutti gli strumenti di contenuto.
doc-type: article
...
![Connessione 5G - Linee guida per i marchi - PDF aperto dalla cartella toolkit](assets/brand-management-open-brand-guideline-pdf.png)
...
![Pulsante Crea marchio nella sezione Marchi](assets/brand-management-click-create-brand-button.png)
...
![Trascinare il PDF Connection5g Brand Guidelines nell&#39;area di caricamento](assets/brand-management-upload-brand-guideline-pdf.png)
...
![Schermata di avanzamento visualizzata durante l&#39;analisi del file delle linee guida per il marchio da parte di AJO](assets/brand-management-extraction-progress-screen.png)
...
![Schermata di configurazione del marchio compilata al termine dell&#39;estrazione](assets/brand-management-brand-configuration-populated.png)

7. Fai clic sul pulsante **Pubblica** per pubblicare le linee guida per il brand.

![Pulsante Pubblica per le linee guida del brand](assets/brand-management-click-publish-button.png)

8. Conferma premendo il pulsante &quot;Publish&quot; (Pubblica).

![Conferma la pubblicazione per le linee guida del brand](assets/brand-management-confirm-publish-dialog.png)
...
![Elenco dei marchi che mostra il nuovo marchio con un&#39;etichetta verde di stato Live](assets/brand-management-brand-live-status-label.png)
...
![Informazioni sulla scheda Marchio che mostra i campi di identità del marchio estratti](assets/brand-management-about-the-brand-tab.png)
...
![Scheda Stile scrittura che definisce il tono del brand, la formulazione e le regole legali](assets/brand-management-writing-style-tab.png)
...
![Scheda Contenuto visivo relativa alle regole per fotografia, illustrazione e iconografia](assets/brand-management-visual-content-tab.png)
...
![Fare clic sulla nuova scheda del marchio Connection 5G](assets/brand-management-click-created-brand-card.png)
...
![Modifica pulsante del marchio e scheda di conferma](assets/brand-management-click-edit-brand-button.png)

3. Vai alla scheda **Informazioni sul marchio**.

![Accesso alla scheda Informazioni sul marchio durante la modifica](assets/brand-management-about-the-brand-tab-edit.png)

4. Individua la sezione per **Principi guida**, **Visione** o una descrizione di alto livello simile.

![Sezione Principi guida e visione nella scheda Informazioni sul marchio](assets/brand-management-guiding-principles-vision-section.png)
...
![Testo per la visione e il posizionamento sul mercato aggiunto al brand](assets/brand-management-vision-market-positioning-added.png)
...
![Scheda Stile scrittura aperta per aggiungere una regola di esclusione](assets/brand-management-writing-style-tab-exclusion.png)

2. Assicurati di essere nella sezione **Stile di comunicazione del marchio**.

![Sezione Stile comunicazione marchio nella scheda Stile scrittura](assets/brand-management-brand-communication-style-section.png)

3. Nell&#39;area **Non**, fai clic sull&#39;icona **più** per aggiungere una nuova regola.

Icona ![Plus nell&#39;area Non aggiungere una nuova regola](assets/brand-management-add-donts-rule-plus-icon.png)
...
![Non confermare la regola push nell&#39;elenco di regole](assets/brand-management-be-pushy-dont-rule-confirmed.png)
...
![Regola di esclusione pulsante e-mail applicata per l&#39;Assistente all&#39;intelligenza artificiale e gli autori](assets/brand-management-email-button-exclusion-rule-applied.png)
...
![Pulsante Pubblica nell&#39;angolo superiore destro](assets/brand-management-click-publish-top-right.png)
...
![Finestra di dialogo di conferma per pubblicare le linee guida per i marchi aggiornate](assets/brand-management-confirm-publish-updated-guidelines.png)
...
![Scheda Linee guida per il marchio Connection 5G con stato Live](assets/brand-management-brand-guidelines-card-live-status.png)
