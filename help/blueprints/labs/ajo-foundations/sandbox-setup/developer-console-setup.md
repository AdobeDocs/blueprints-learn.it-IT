---
hold: true
title: Configurazione Developer Console
description: Crea un progetto Adobe Developer Console con credenziali server-to-server OAuth per le API Experience Platform e Journey Optimizer utilizzate da DEP CLI.
doc-type: article
...
# Configurazione Developer Console
...
1. Seleziona il profilo prodotto che corrisponde alla sandbox in uso, quindi seleziona **Salva API configurata**

## Aggiungi API Adobe Journey Optimizer

1. Dalla panoramica del progetto, seleziona **Aggiungi API**
1. Scegli l&#39;icona del prodotto **Adobe Journey Optimizer** e seleziona l&#39;API pertinente
1. Seleziona **Server-to-Server OAuth**
1. Seleziona lo stesso profilo di prodotto e seleziona **Salva API configurata**

>[!NOTE]
>
>Riutilizzare le credenziali create in precedenza invece di crearne una nuova. CLI richiede un solo set di credenziali, con ambiti combinati.



## Raccogliere i valori

Apri la pagina di panoramica **OAuth Server-to-Server** delle credenziali. Sono necessari quattro valori per il file di ambiente CLI:
...
>[!NOTE]
>
>Copiare gli ambiti predefiniti visualizzati nella pagina delle credenziali. Non è necessario aggiungere nulla manualmente. Se hai aggiunto entrambe le API qui sopra, l’elenco degli ambiti includerà automaticamente entrambe.
