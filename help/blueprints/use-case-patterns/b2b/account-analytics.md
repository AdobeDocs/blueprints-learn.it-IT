...
- [ ] [!DNL CJA] La licenza B2B edition è attiva ed è stato eseguito il provisioning per l&#39;organizzazione
- [ ] [!DNL RT-CDP] La licenza B2B edition è attiva con schemi B2B e profili account configurati
- [ ] schemi XDM B2B definiti (account, opportunità, relazione persona account, relazione persona opportunità, membri elenco marketing)
- [ ] [!DNL Marketo Engage] e/o i connettori di origine CRM sono configurati e stanno acquisendo attivamente i dati
- [ ] i dati dell&#39;evento comportamentale a livello di account (visite Web, interazioni e-mail, invii di moduli) fluiscono in AEP con associazione di account
...
- [ ] Le parti interessate hanno concordato l&#39;acquisto di definizioni di ruolo di gruppo e mapping di interessi per la soluzione
- [ Per gli account utente di ] [!DNL CJA] è stato eseguito il provisioning con i profili di prodotto appropriati per le funzionalità di B2B edition
- [ ] i KPI di destinazione e i requisiti di reporting sono stati definiti dai responsabili marketing e vendite
...
**Funzionalità applicazione:** [!DNL CJA] B2B: Connessione basata su account, [!DNL CJA]: Connessione dati
...
**Funzionalità applicazione:** [!DNL CJA] B2B: configurazione visualizzazione dati B2B, [!DNL CJA]: configurazione visualizzazione dati
...
**Funzionalità dell&#39;applicazione:** [!DNL CJA] B2B: Analisi Workspace a livello di account, Analisi del gruppo di acquisto, Analisi dell&#39;opportunità, Segmentazione B2B, Attribuzione B2B, [!DNL CJA]: Analisi Workspace, Creazione di metriche calcolate, Analisi guidata
...
**Funzionalità applicazione:** [!DNL CJA]: pubblicazione dashboard e scorecard, [!DNL CJA]: pubblicazione pubblico
