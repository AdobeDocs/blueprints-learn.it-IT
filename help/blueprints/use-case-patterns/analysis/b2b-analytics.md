...
- [!DNL CJA] connessioni possono includere set di dati da una sola sandbox AEP — [guardrail CJA](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-admin/guardrails)
