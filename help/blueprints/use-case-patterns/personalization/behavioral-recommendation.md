...
| Reporting e analisi | Incluso | La generazione di rapporti sulle prestazioni dei consigli fa parte del passaggio 4 del piano di esecuzione. L&#39;analisi [!DNL Customer Journey Analytics] dell&#39;efficacia dei consigli, dell&#39;impatto sui ricavi e delle prestazioni a livello di elemento su superfici e segmenti fornisce informazioni approfondite sull&#39;ottimizzazione. | [Panoramica di CJA](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-overview/cja-overview), [Panoramica di Analysis Workspace](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-workspace/home) |
...
**Funzionalità applicazione:** AEP: modellazione e preparazione dati (F2), AEP: origini dati e raccolta (F3)
...
**Funzionalità applicazione:** AEP: configurazione identità e profilo (F4)
...
**Per L&#39;Opzione C (Consigli Sul Comportamento Delle E-Mail):**
...
**Funzionalità dell&#39;applicazione:** RT-CDP: Audience Evaluation, AJO: Campaign Execution o Journey Orchestration
...
**Funzionalità dell&#39;applicazione:** AJO: Reporting &amp; Performance Analysis, S5: Reporting &amp; Analysis
...
- Massimo 10.000 offerte personalizzate approvate (elementi di decisione) per sandbox — [Guardrail di gestione delle decisioni](https://experienceleague.adobe.com/it/docs/journey-optimizer/using/get-started/guardrails)
...
- In Edge può essere attivo un solo criterio di unione per sandbox — [Guardrail di profilo](https://experienceleague.adobe.com/it/docs/experience-platform/profile/guardrails)
...
- Acquisizione in streaming: massimo 20.000 record al secondo per connessione HTTP — [Guardrail di acquisizione](https://experienceleague.adobe.com/it/docs/experience-platform/ingestion/guardrails)
