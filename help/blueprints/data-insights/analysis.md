...
Ulteriori casi d’uso comuni per il servizio di query sono descritti qui [Casi d’uso del servizio query](https://experienceleague.adobe.com/docs/experience-platform/query/use-cases/abandoned-browse.html)
...
[Guida a Query Service](https://experienceleague.adobe.com/docs/experience-platform/query/guardrails.html)
...
1. Conferma che i dati siano disponibili per [[!UICONTROL Servizio query]](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/explore-data.html?lang=it).
1. [Collegare gli strumenti di Business Intelligence e i client SQL a [!UICONTROL Query Service]](https://experienceleague.adobe.com/docs/experience-platform/query/clients/overview.html) per la visualizzazione, l’interrogazione e l’esplorazione dei dati.
