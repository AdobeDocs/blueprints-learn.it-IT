...
* Eventi di persone.
   ...
   * AND/OR è supportato (si può quindi dire &quot;A e B devono accadere&quot;,  ma non si può dire &quot;A deve accadere 3 giorni prima di B&quot;).
* Massimo 5 milioni di account in tutti i percorsi di account
* Massimo 40 milioni di persone in tutti i percorsi di account
* Massimo 1.000 persone per account in un percorso di acquisto
* [Guardrail per profili e segmentazione](https://experienceleague.adobe.com/it/docs/experience-platform/profile/guardrails)
...
* Configura il [connettore di origine Marketo Engage](https://experienceleague.adobe.com/it/docs/experience-platform/sources/connectors/adobe-applications/marketo/marketo)
   * Utilizza il dizionario dati definito in precedenza per definire la [Mappatura importazione](https://experienceleague.adobe.com/it/docs/experience-platform/data-prep/ui/mapping#import-mapping) per il connettore di origine
...
* Implementa [Regole di collegamento del grafico delle identità](https://experienceleague.adobe.com/it/docs/experience-platform/identity/features/identity-graph-linking-rules/overview) per gli utenti:
   * Definisci come collegare i record Persona utilizzando gli spazi dei nomi di identità (ad esempio e-mail, b2b_person).
...
* Definisci [gruppi di acquisto](https://experienceleague.adobe.com/it/docs/journey-optimizer-b2b/user/accounts/buying-groups/buying-groups-overview) o un [percorso di account](https://experienceleague.adobe.com/it/docs/journey-optimizer-b2b/user/account-journeys/journey-overview) utilizzando il pubblico dell&#39;account
   * Il processo del gruppo di acquisto viene eseguito ogni giorno ed elabora nuovi account qualificati come pubblico account o persone appena associate
   * La manutenzione del gruppo di acquisto viene eseguita ogni venerdì a mezzanotte, quindi la rimozione dei membri o l&#39;aggiunta di membri appena qualificati si verifica solo il venerdì
