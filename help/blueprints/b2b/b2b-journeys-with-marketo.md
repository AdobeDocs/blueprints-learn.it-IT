...
>[!TIP]
>Questo blueprint è disponibile anche come [modello di caso d&#39;uso](/help/blueprints/use-case-patterns/b2b/marketo-data-journeys.md) in Attivazione e marketing B2B.
...
* [Gestione dei campi XDM (Journey Optimizer B2B edition)](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/admin/xdm-field-management/xdm-field-management)
